...
$org_address2 = "";
$org_district = "";
$org_citymun = "Tabilaran City";
$org_province = "Bohol";
$org_region = "Region VII";

// Application
$app_fullname = "Certificate Generator";
...
// Built-in user
$user_username = "admin";
$user_password = "Fernan1%";
$user_id = "1";
$user_fullname = "Fernando B. Enad";
$user_avatar = "$user_id.jpg";
$user_roleID = "1";
